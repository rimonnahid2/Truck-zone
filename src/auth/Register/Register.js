      ...
      <div className="bg-gray-100">
        <div className='container md:mx-auto py-10'>
          <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            <div className="hidden bg-cover lg:block lg:w-1/2" style={{ backgroundImage: "url('https://www.amazingviralnews.com/wp-content/uploads/2021/02/Hiring-a-Truck-Company.jpg')" }}></div>
